...
plot ARG1 i 1 every ::0::0 u 2:3 w points ls 5 ps 2 lc rgb "orange" title sprintf("Depot"), \
	 ...
	 ARG1 i 1 every ::(REQUESTS * 2 + 1)::(REQUESTS * 2 + 1) u 2:3 w points ls 5 ps 2 lc rgb "orange" notitle, \
	 ARG1 i 1 every ::(REQUESTS * 2 + 2)::(REQUESTS * 2 + STATIONS + 1) u 2:3 w points ls 9 ps 2.5 lc rgb "black" title sprintf("Station"), \
